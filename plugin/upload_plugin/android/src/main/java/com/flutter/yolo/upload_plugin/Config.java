...
public class Config {
    ...
    public static final String BUCKET_NAME = "yololog";
    public static final String OSS_ACCESS_KEY_ID = "LTAI5tCXotMoJgFqAXrdtBgo";
    public static final String OSS_ACCESS_KEY_SECRET = "k5zPehsTM3bgjcNw7mpnPsXeojvvMo";
